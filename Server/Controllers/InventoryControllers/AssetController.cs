...
//         // POST: api/stock/assets
// [HttpPost]
//  void AddStock(Stock stock)
// {
//      stock.StockId=1;
// while(stock.StockId!=null){

//     for(int i=0;i<stock.Amount;i++){
//      async Task<ActionResult<AssetToReturn>> CreateAsset(AssetToCreate assetToCreate)
//         {
...
//                     Vendor = stock.SupplierName,
//                     Status = "status",
//                     Condition = "condition",
//                     WarrantyExpiration = stock.WarrantyExpiring,
//                     StockId = stock.StockId ,
//                     BarcodeImageBase64 = "hjjjk"
//                 };
